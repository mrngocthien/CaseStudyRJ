      ...
      <div className='w-1/4'>
        <form action="" className='flex flex-col gap-2' onSubmit={handleSubmit}>
          ...
          <div className='flex items-center justify-around gap-2'>
            <button type='submit' onSubmit={handleSubmit} className='gap-2 bg-dark-violet hover:bg-light-violet hover:text-white text-gray-100 py-1 px-4 w-[150px] text-center rounded-full'>Đăng nhập</button>
            <span>Hoặc</span>
